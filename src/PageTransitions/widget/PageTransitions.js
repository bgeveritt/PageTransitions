...
require({
    ...
    'mxui/dom', 'dojo/dom', 'dojo/query', 'dojo/dom-prop', 'dojo/dom-geometry', 'dojo/dom-class', 'dojo/dom-style', 'dojo/dom-construct', 'dojo/_base/array', 'dojo/_base/lang', 'dojo/text', 'dojo/text!PageTransitions/widget/template/PageTransitions.html'
    ...
    return declare('PageTransitions.widget.PageTransitions', [_WidgetBase, _TemplatedMixin], {
